...
public class Arreglos08 {
    ...
    public static void main(String[] args) {
        ...
        // Inicializar una variable booleana para verificar si el n�mero se encuentra en el arreglo
        ...
        // Si no se encuentra el n�mero (la variable encontrado sigue siendo false), imprimir "NO"
        if (!encontrado) {
