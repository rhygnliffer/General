...
public class Arreglos06 {
    /**Ejercicio 6:
     ...
     elemento en la posici�n 1 del arreglo A con el elemento en la misma posici�n del arreglo B y
     as� sucesivamente. Almacenar el resultado en un arreglo C e imprima el resultado final.
     */
