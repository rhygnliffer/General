...
public class Arreglos09 {
    /**Ejercicio 9:
     Escriba un algoritmo que efect�e la normalizaci�n de una colecci�n de n�meros reales (float).
     Para llevar a cabo esta normalizaci�n, se debe en primer lugar encontrar el n�mero mayor de la
     colecci�n; luego se divide cada n�mero por dicho valor m�ximo, de forma que los valores
    ...
    public static void main(String[] args) {
        ...
        // Normalizar la colecci�n de n�meros reales dividiendo cada n�mero por el valor m�ximo
        for (int i = 0; i < n; i++) {
