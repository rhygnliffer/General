...
public class Arreglos07 {
    /**Ejercicio 7:
     Dise�e un algoritmo que lea dos arreglos A y B de 20 elementos cada uno y multiplique el
     primer elemento de A con el �ltimo elemento de B y luego el segundo elemento de A por el
     d�cimo noveno elemento de B y as� sucesivamente hasta llegar al veinteavo elemento de A por
